    ...
    <div class="container">
        <div class="row">
            <form action="process.php?process=login" method="post" class="position-absolute top-50 start-50 translate-middle " style="width:310px; height:275px;">
                <input class="mb-2 rounded text-center"  type="email" name="email" value="" placeholder="Mail Adresiniz" required />
                ...
                <a class="text-decoration-none text-black" style="margin-left:70px; color:black;" href="sign_up.php">Kayıt olmak için tıklayın</a>
            </form>
        </div>
    </div>
